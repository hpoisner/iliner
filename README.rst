...
Required Arguments:
  ...
  --haps HAPLOTYPE, -hp HAPLOTYPE  Location of the Haplotype File. This should
  be in PLINK format and should be phase.

  --VCF VCF, -v VCF  Location of the VCF. This should phased and in standard genotype format.

  --genetic_map GENTICMAP, -gm GENETICMAP  Location of the genetic map.
  This should be for the same build as the genotype files.
